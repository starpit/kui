...
- **plugins/plugin-proxy-support:** proxy-executor renderDom fails if nodeType is undefined ([58f4011](https://github.com/IBM/kui/commit/58f4011)), closes [#2644](https://github.com/IBM/kui/issues/2644)
